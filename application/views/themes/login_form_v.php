...
<head>
	<meta charset="UTF-8">
	<title>KOPERAS-DLHK.ONLINE</title>
...
<body>
	...
	<div class="form-box" id="login-box">
		...
		<form action="" method="post" alignment="center">
			<div class="body bg-gray" alignment="center">
				<?php if($jenis == 'member') { ?>
					<h4>Anda Login sebagai <b>MEMBER</b> - <a href="<?php echo site_url('login'); ?>" class="btn btn-success">Klik untuk login sebagai ADMIN</a></h4>
				<?php } else { ?>
					<h4>Anda Login sebagai <b>ADMIN</b> - <a href="<?php echo site_url('member'); ?>" class="btn btn-primary">Klik untuk login sebagai MEMBER</a></h4>
				<?php } ?>
			...
			<div class="footer"> 
				&copy; Copyright <?php echo date('Y'); ?> | Made with love by <a href="https://robialakbar.com/" target="_blank"><b>robi al akbar</b>.</a> 
			</div>
		</form>
	</div>
