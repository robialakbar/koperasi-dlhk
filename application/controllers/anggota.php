...
class Anggota extends OperatorController {
	...
	public function index() {
		...
		$crud->field_type('departement','dropdown',
			array(
				'' 						=> '',
				'DLHK Prov Babel' 		=> 'DLHK Prov Babel',
				'UPTD Laboratorium Lingkungan' 	=> 'UPTD Laboratorium Lingkungan',
				'UPTD KPHP Jebu Bambang Antan' 						=> 'UPTD KPHP Jebu Bambang Antan',
				'UPTD KPHP Bubus Panca' 						=> 'UPTD KPHP Bubus Panca' ,
				'UPTD KPHP Gunung Duren' 					=> 'UPTD KPHP Gunung Duren',
				'UPTD KPHL Belantu Mendanau' 						=> 'UPTD KPHL Belantu Mendanau',
				'UPTD KPHP Rambat Menduyung' 			=> 'UPTD KPHP Rambat Menduyung',
				'UPTD KPHP Muntai Palas' 			=> 'UPTD KPHP Muntai Palas',
				'UPTD KPHP Sungai Sembulan' 			=> 'UPTD KPHP Sungai Sembulan',
				'UPTD KPHP Sigambir Kotawaringin' 			=> 'UPTD KPHP Sigambir Kotawaringin'
			));
